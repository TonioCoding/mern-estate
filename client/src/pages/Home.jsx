       ...
       {/* Top */}
        ...
        max-w-6xl mx-auto">
          ...
          <div className="text-gray-400  text-xs sm:text-sm">
            Sell & Tell Estates is the best place to find your next
            perfect place to leave
            <br />
            We have a wide range of propertiess fro you to
            choose from.
          </div>
...

          {
            rentListings && rentListings.length > 0 && (
              <div className="">
                <div className="my-3">
                  <h2 className='text-2xl font-semibold
                  text-slate-600'>Recent properties for rent</h2>
                  <Link className='text-sm text-blue-800
...

          {
            saleListings && saleListings.length > 0 && (
              <div className="">
                <div className="my-3">
                  <h2 className='text-2xl font-semibold
                  text-slate-600'>Recent properties for sale</h2>
                  <Link className='text-sm text-blue-800
