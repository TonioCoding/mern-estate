...
export default function Profile (){
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <h1 className="text-center mt-7 text-2xl font-semibold">User's Listings</h1> 
        ...
        (<div key={listing._id} className="border rounded-lg 
          ...
          <div className='flex flex-col items-center'> 
            <button  onClick={()=>handleListingDelete(listing._id)} className='text-red-700 uppercase hover:text-red-500'>Delete</button>
            <Link to={`/update-listing/${listing._id}`}>
              <button className='text-green-700 uppercase py-2 hover:text-green-500'>Edit</button>
            </Link>
          </div>
        </div>))}
